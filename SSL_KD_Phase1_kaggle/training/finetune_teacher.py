...
from SSL_KD_Phase1_kaggle.models.teacher.classifier_head import ClassifierHead
...
class TeacherFineTuneModel(nn.Module):
    def __init__(self, num_classes=5, mode='frozen'):
        ...
        self.classifier = ClassifierHead(embedding_dim=522, num_classes=num_classes)
        self.set_mode(mode)
    ...
    def forward(self, lead2, morphology, age_gender=None):
        ...
        outputs = self.encoder(lead2, morphology, age_gender)
