...
Usage:
    python preprocess_cinc2020.py --data_dir D:\Datasets\phsionet_2020\ --target_fs 257 --seq_length 4096
...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default=r'D:\Datasets\phsionet_2020', help="Root path of CINC2020 dataset")
